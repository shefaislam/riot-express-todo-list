...
function transferProjectToRemote(failed, successful) {
  return ssh.putDirectory(
    '../riot-expres-todo-list',
    '/home/ubuntu/riot-expres-todo-list-temp',
    {
      recursive: true,
      concurrency: 1,
...
function createRemoteTempFolder() {
  return ssh.execCommand(
    'rm -rf riot-expres-todo-list-temp && mkdir riot-expres-todo-list-temp', {
      cwd: '/home/ubuntu'
  });
}
...
function updateRemoteApp() {
  return ssh.execCommand(
    'mkdir riot-expres-todo-list && cp -r riot-expres-todo-list-temp/* riot-expres-todo-list/ && rm -rf riot-expres-todo-list-temp', {
      cwd: '/home/ubuntu'
  });
}
...
function restartRemoteServices() {
  return ssh.execCommand(
    'cd riot-expres-todo-list && sudo service mongod start && pm2 start app.js', {
      cwd: '/home/ubuntu'
  });
}
...
function sshConnect() {
  ...
  ssh
    ...
    .then(function() {
      console.log('Creating `riot-expres-todo-list-temp` folder.');
